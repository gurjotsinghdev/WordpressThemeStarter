...
function wds_scripts() {
	wp_enqueue_style( 'wds-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'wds-style', 'rtl', 'replace' );

	wp_enqueue_script( 'wds-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
